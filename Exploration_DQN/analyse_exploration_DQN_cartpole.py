...
for e in range(Experiments):
    ...
    agent = AgentEpsGreedy(n_actions=n_actions, value_function_model=value_function, eps=0.3)
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Exploration_Strategies_DQN/Averaged_Experiments_Results/'  + 'Cum_Rwd_' + 'Only_Epsilon_Greedy_' + str(e) + '.npy', total_reward)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Exploration_Strategies_DQN/Averaged_Experiments_Results/'   + 'Average_Cum_Rwd_' + 'Only_Epsilon_Greedy_' + '.npy', Average_Cum_Rwd)
