...
for e in epsilon_param:
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Average_DQN_Mountain_Car_Results/'  + 'mountain_car_cumulative_reward' + 'Epsilon_Param_' + str(e) + '.npy', total_reward)
