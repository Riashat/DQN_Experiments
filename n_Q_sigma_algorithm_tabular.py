...
def plot_episode_stats(stats1, stats2, stats3, stats4, stats5, stats6, smoothing_window=200, noshow=False):
    ...
    plt.title("Comparing with Q(sigma)")
    plt.show()
...
def main():
	...
	Q_Sigma, stats_q_sigma = q_sigma_on_policy(env, Number_Episodes)

	print "Plotting Cumulative Rewards"
	plot_episode_stats(stats_SARSA, stats_expected_sarsa, stats_two_step_tree_backup, stats_three_step_tree_backup, stats_q_learning, stats_q_sigma)
