...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Exploration_Strategies_DQN/Averaged_Experiments_Results/'  + 'Cum_Rwd_' + 'Only_Boltzmann_' + str(e) + '.npy', total_reward)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Exploration_Strategies_DQN/Averaged_Experiments_Results/'   + 'Average_Cum_Rwd_' + 'Only_Boltzmann_' + '.npy', Average_Cum_Rwd)
