...
min_avg_Rwd = 100000  # Minimum average reward to consider the problem as solved
...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Average_DQN_Acrobat_Results/'  + 'Acrobat_cumulative_reward' + 'Experiment_' + str(e) + '.npy', total_reward)
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Average_DQN_Acrobat_Results/'  + 'Acrobat_V0_value_function_loss' + 'Experiment_' + str(e) + '.npy', loss_per_ep)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Average_DQN_Acrobat_Results/'  + 'Average_Cum_Rwd_Acrobat' + '.npy', Average_Cum_Rwd)
