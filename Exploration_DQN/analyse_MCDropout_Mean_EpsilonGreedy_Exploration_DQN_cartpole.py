...
def run_episode(env,
    ...
    for i in range(max_step):
        ...
        #using a Boltzmann Exploration Policy here
        action = agent.act_mc_dropout_EpsilonGreedy(state)
        ...
        if len(memory.memory) > batch_size:  # DQN Experience Replay
            ...
            #significances of changes in the batch size
...
for e in range(Experiments):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Exploration_Strategies_DQN/Averaged_Experiments_Results/'  + 'Cum_Rwd_' + 'MCDropout_EpsilonGreedy_' + str(e) + '.npy', total_reward)
...
np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/Exploration_Strategies_DQN/Averaged_Experiments_Results/'   + 'Average_Cum_Rwd_' + 'MCDropout_EpsilonGreedy_' +  '.npy', Average_Cum_Rwd)
